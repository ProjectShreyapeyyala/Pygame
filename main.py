...
pygame.display.set_caption("Pajo")
...
def load_sprites_sheets(dir1,dir2,width,height,direction=False):
    path= join("Project1","assets",dir1,dir2)
...
def get_block(size):
    path=join("Project1","assets","Terrain","Terrain.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def update_sprite(self):
        ...
        self.sprites=sprites[sprite_index]
    ...
    def draw(self, win,offset_x):
        ...
        win.blit(self.sprites,(self.rect.x-offset_x,self.rect.y))
...
def get_background(name):
    image=pygame.image.load(join("Project1","assets","Background",name))
